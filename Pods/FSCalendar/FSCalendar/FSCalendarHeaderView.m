...
- (void)initialize
{
    ...
    collectionView.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:212.0/255.0 blue:41.0/255.0 alpha:1.0];
...
- (void)configureCell:(FSCalendarHeaderCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.font = [UIFont fontWithName:@"GothamRounded-Medium" size:15.0f];//appearance.headerTitleFont;
