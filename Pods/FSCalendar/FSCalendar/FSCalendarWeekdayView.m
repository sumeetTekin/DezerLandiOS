...
- (void)layoutSubviews
{
    ...
    self.contentView.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:249.0/255.0 blue:226.0/255.0 alpha:1.0];
    ...
    for (NSInteger i = 0; i < count; i++) {
        ...
        label.font = [UIFont fontWithName:@"GothamRounded-Medium" size:11.0f];;
