...
public extension TabmanBar {
    ...
    public struct Item {
        ...
        public private(set) var highlightedImageURL: URL?
        ...
        public init(title: String, image: UIImage, imageURL: URL?, highlightedImageURL: URL?, context: Any? = nil) {
            self.title = title
            self.image = image
            self.context = context
            self.imageURL = imageURL
            self.highlightedImageURL = highlightedImageURL
        }
    }
}
